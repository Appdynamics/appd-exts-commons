...
@PrepareForTest({KubernetesDiscoveryModule.class})
public class KubernetesDiscoveryModuleTest {

    private static final String CONFIG_FILE = "src/test/resources/k8s/config.yml";

    private KubernetesDiscoveryModule kubernetesDiscoveryModule = new KubernetesDiscoveryModule();
    ...
    public void testProcessForSingleServer() throws Exception {
        ...
        List<Map<String, ?>> serversList = (List<Map<String, ?>>) configAfterProcess.getValue().get("servers");
