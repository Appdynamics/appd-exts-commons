...
public class WorkBenchModule {
    ...
    public void initWorkBenchStore(Map<String, ?> config, String metricPrefix, ControllerInfo controllerInfo) {
        if(isWorkbenchMode()){
            WorkbenchMetricStore.initialize(controllerInfo, derivedMetricsModule.initDerivedMetricsCalculator(config, metricPrefix));
